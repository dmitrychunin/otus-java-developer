...
import ru.otus.javadeveloper.hw07.exceptions.AtmHasNotEnoughBanknotesException;
...
class BankNoteContainer implements AtmContainer {
    ...
    public List<BankNote> peekSum(int sum) {
        ...
        if (current != sum) {
            ...
            throw new AtmHasNotEnoughBanknotesException("ru.otus.javadeveloper.hw07.atm.Atm has not enough banknotes");
        }
